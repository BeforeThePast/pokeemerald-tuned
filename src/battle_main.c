...
const u8 gTypeEffectiveness[336] =
{
    ...
    TYPE_BUG, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
...
{
    {TRAINER_CLASS_TEAM_AQUA, 25},
    {TRAINER_CLASS_AQUA_ADMIN, 30},
    {TRAINER_CLASS_AQUA_LEADER, 35},
    {TRAINER_CLASS_AROMA_LADY, 12},
    {TRAINER_CLASS_RUIN_MANIAC, 35},
    {TRAINER_CLASS_INTERVIEWER, 12},
    {TRAINER_CLASS_TUBER_F, 16},
    {TRAINER_CLASS_TUBER_M, 16},
    {TRAINER_CLASS_SIS_AND_BRO, 11},
    {TRAINER_CLASS_COOLTRAINER, 16},
    {TRAINER_CLASS_HEX_MANIAC, 18},
    {TRAINER_CLASS_LADY, 50},
    {TRAINER_CLASS_BEAUTY, 20},
    {TRAINER_CLASS_RICH_BOY, 50},
    {TRAINER_CLASS_POKEMANIAC, 15},
    {TRAINER_CLASS_SWIMMER_M, 12},
    {TRAINER_CLASS_BLACK_BELT, 18},
    {TRAINER_CLASS_GUITARIST, 18},
    {TRAINER_CLASS_KINDLER, 28},
    {TRAINER_CLASS_CAMPER, 14},
    {TRAINER_CLASS_OLD_COUPLE, 10},
    {TRAINER_CLASS_BUG_MANIAC, 15},
    {TRAINER_CLASS_PSYCHIC, 30},
    {TRAINER_CLASS_GENTLEMAN, 20},
    {TRAINER_CLASS_ELITE_FOUR, 40},
    {TRAINER_CLASS_LEADER, 35},
    {TRAINER_CLASS_SCHOOL_KID, 15},
    {TRAINER_CLASS_SR_AND_JR, 14},
    {TRAINER_CLASS_POKEFAN, 20},
    {TRAINER_CLASS_EXPERT, 18},
    {TRAINER_CLASS_YOUNGSTER, 19},
    {TRAINER_CLASS_CHAMPION, 50},
    {TRAINER_CLASS_FISHERMAN, 10},
    {TRAINER_CLASS_TRIATHLETE, 10},
    {TRAINER_CLASS_DRAGON_TAMER, 12},
    {TRAINER_CLASS_BIRD_KEEPER, 18},
    {TRAINER_CLASS_NINJA_BOY, 12},
    {TRAINER_CLASS_BATTLE_GIRL, 26},
    {TRAINER_CLASS_PARASOL_LADY, 10},
    {TRAINER_CLASS_SWIMMER_F, 22},
    {TRAINER_CLASS_PICNICKER, 24},
    {TRAINER_CLASS_TWINS, 13},
    {TRAINER_CLASS_SAILOR, 18},
    {TRAINER_CLASS_COLLECTOR, 15},
    {TRAINER_CLASS_RIVAL, 35},
    {TRAINER_CLASS_PKMN_BREEDER, 20},
    {TRAINER_CLASS_PKMN_RANGER, 22},
    {TRAINER_CLASS_TEAM_MAGMA, 15},
    {TRAINER_CLASS_MAGMA_ADMIN, 20},
    {TRAINER_CLASS_MAGMA_LEADER, 20},
    {TRAINER_CLASS_LASS, 21},
    {TRAINER_CLASS_BUG_CATCHER, 14},
    {TRAINER_CLASS_HIKER, 17},
    {TRAINER_CLASS_YOUNG_COUPLE, 18},
    {TRAINER_CLASS_WINSTRATE, 23},
